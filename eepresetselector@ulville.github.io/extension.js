...
const EEPSSystemIndicator = GObject.registerClass(
    class EEPSSystemIndicator extends QuickSettings.SystemIndicator {
...
const EEPSMenuToggle = GObject.registerClass(
    class EEPSMenuToggle extends QuickSettings.QuickMenuToggle {
        _init(extensionObject) {
            super._init({
                title: _('Easy Effects'),
                subtitle: _('Example Subtitle'),
                gicon: Gio.icon_new_for_string(
                    `${extensionObject.path}/icons/eepresetselector-symbolic.svg`
                ),
                toggleMode: true,
            });
            ...
            this.menu.setHeader(this.gicon, _('EasyEffects Preset Selector'),
                _('Optional Subtitle'));
            ...
            this.connect('clicked', () => {
                this._enableGlobalBypass(this.checked);
            });
        ...
        _buildMenu(outputCategoryName, inputCategoryName, command) {
            ...
            let _maxHeight = 300; // _menuThemeNode.get_max_height();
            ...
            if (_notFillsScreen) {
                ...
                _outputScrollView.vscrollbar_policy = _outputNeedsScrollbar ? St.PolicyType.ALWAYS : St.PolicyType.NEVER;

                let _inputNeedsScrollbar = _maxHeight >= 0 && _inputNaturH + _titleNaturH >= (_maxHeight - _eeActNaturH - _sepNaturH - _toggleBypassNaturH) / 2;
                _inputScrollView.vscrollbar_policy = _inputNeedsScrollbar ? St.PolicyType.ALWAYS : St.PolicyType.NEVER;
            }
        }
...
export default class EEPSExtension extends Extension {
    enable() {
        ...
        // this._indicator1 = new EEPSIndicator(this._settings, this.path);
        this._indicator2 = new EEPSSystemIndicator(this);
        this._indicator2.quickSettingsItems.push(new EEPSMenuToggle(this));
        // Main.panel.addToStatusArea(this.uuid, this._indicator1);
